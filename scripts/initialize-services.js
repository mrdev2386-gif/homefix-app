 ...
 * 
 * This script creates ALL service categories and sub-services with FIXED pricing
 * for the HomeFix platform (Urban Company style)
 * 
 * Run this ONCE to populate the database with production-ready services
 * 
 * Usage:
...
const serviceAccount = require('../.security/homefix-service-account.json');
...
const PRICING_CONFIG = {
    defaultInspectionCharge: 99, // ₹99 default inspection charge
    inspectionChargeRefundable: true, // Refund if customer proceeds
...
const SERVICES_DATA = [
    ...
    // ========================================================================
    {
        service: {
            ...
            isFeatured: true,
            order: 3,
            requiresInspection: false, // Most fan issues are straightforward
            inspectionCharge: 0,
