...
cd functions
call npm run build
call firebase deploy --only functions:createBookingRequest,functions:approveBookingRequest,functions:technicianRespondToJob,functions:payBeforeWork,functions:completeService,functions:confirmAfterWorkPayment,functions:generateTechnicianQR,functions:updateBookingStatus
...
REM Deploy Firestore Rules (if needed)
