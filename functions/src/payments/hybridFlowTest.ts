...
function logResult(status: 'PASS' | 'FAIL', message: string) {
    const color = status === 'PASS' ? 'green' : 'red';
    log(`${status === 'PASS' ? '✔' : '✖'} ${message}`, color);
}

async function waitForUser(action: string): Promise<void> {
...
async function step0_setup(): Promise<{ customerId: string; technicianId: string; serviceId: string }> {
...
async function step1_customerBooking(customerId: string): Promise<void> {
...
async function step2_verifyBookingCreated(customerId: string): Promise<string> {
...
async function step3_adminApproval(bookingId: string): Promise<void> {
...
async function step4_verifyAdminUpdate(bookingId: string): Promise<void> {
...
async function step5_technicianAccept(bookingId: string): Promise<void> {
...
async function step6_verifyTechnicianAccept(bookingId: string): Promise<void> {
...
async function step7_serviceComplete(bookingId: string): Promise<void> {
...
async function step8_verifyPaymentState(bookingId: string): Promise<void> {
...
async function step9_payment(bookingId: string): Promise<void> {
...
async function step10_verifyPaymentResult(bookingId: string): Promise<void> {
...
async function step11_verifyWallet(bookingId: string): Promise<void> {
...
async function step12_realTimeCheck(): Promise<void> {
...
async function step13_logCheck(bookingId: string): Promise<void> {
...
function step14_finalResult(): void {
