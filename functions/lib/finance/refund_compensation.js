...
exports.autoRetryCompensations = exports.getPendingCompensations = exports.retryAllPendingCompensations = exports.retryRefundCompensation = void 0;
 ...
 */
async function retryWalletAdjustment(compensationId) {
    try {
        const compensationRef = config_1.db.collection('refund_compensations').doc(compensationId);
        ...
        await config_1.db.collection('refund_compensations').doc(compensationId).update({
            lastRetryAt: admin.firestore.FieldValue.serverTimestamp(),
 ...
 */
exports.retryRefundCompensation = functions
    .region('asia-south1')
 ...
 */
exports.retryAllPendingCompensations = functions
    .region('asia-south1')
    .https.onCall(async (data, context) => {
    await (0, utils_1.assertAdmin)(context);
    const { limit = 50 } = data;
 ...
 */
exports.getPendingCompensations = functions
    .region('asia-south1')
    .https.onCall(async (data, context) => {
    await (0, utils_1.assertAdmin)(context);
...
//# sourceMappingURL=refund_compensation.js.map