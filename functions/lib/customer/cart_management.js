...
exports.clearCartCallable = exports.removeFromCartCallable = exports.updateCartQuantityCallable = exports.addToCartCallable = void 0;
 ...
 */
exports.addToCartCallable = functions
    .region('asia-south1')
    ...
    const subServiceName = data.subServiceName ?? '';
    const serviceImage = data.serviceImage ?? '';
    const price = typeof data.price === 'number' ? data.price : 0;
    const quantity = typeof data.quantity === 'number' ? data.quantity : 1;
    const finalPriceSnapshot = typeof data.finalPriceSnapshot === 'number' ? data.finalPriceSnapshot : price;
 ...
 */
exports.updateCartQuantityCallable = functions
    .region('asia-south1')
    .https.onCall(async (data, context) => {
 ...
 */
exports.removeFromCartCallable = functions
    .region('asia-south1')
    .https.onCall(async (data, context) => {
 ...
 * Clear entire cart
 */
exports.clearCartCallable = functions
    .region('asia-south1')
    .https.onCall(async (data, context) => {
...
//# sourceMappingURL=cart_management.js.map