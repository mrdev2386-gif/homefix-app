...
exports.admin_backfillImages = exports.admin_initializeHomeContent = void 0;
 ...
 */
exports.admin_backfillImages = functions.region('asia-south1').https.onCall(async (data, context) => {
    // Security Check
    if (!context.auth || context.auth.token.admin !== true) {
    ...
    const getFallbackUrl = (name, category = '') => {
...
//# sourceMappingURL=system_initialization.js.map