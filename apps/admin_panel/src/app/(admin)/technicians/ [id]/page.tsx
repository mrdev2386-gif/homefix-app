                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="text-lg font-bold text-slate-200">{tech.city || 'Sector Pending'}</div>
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="divide-y divide-slate-800/50">
                                    {tech.jobHistory.map((job: any) => (
                                        <div key={job.id} className="p-6 flex items-center justify-between hover:bg-white/5 transition-colors group">
                                            <div className="flex items-center gap-4">
                                                <div className="text-sm font-black text-white uppercase tracking-tight">{job.serviceTitle}</div>
                                            </div>
