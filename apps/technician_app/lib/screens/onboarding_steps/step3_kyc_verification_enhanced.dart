...
class Step3KycVerificationEnhanced extends StatefulWidget {
  final Map<String, dynamic> formData;
  final Function(String, dynamic) onDataChanged;

  const Step3KycVerificationEnhanced({
    super.key,
  ...
  @override
  State<Step3KycVerificationEnhanced> createState() => _Step3KycVerificationEnhancedState();
}

class _Step3KycVerificationEnhancedState extends State<Step3KycVerificationEnhanced> {
    ...
    try {
      ...
      if (image != null) {
        ...
        setState(() {
          ...
          if (type == 'pan') _isUploadingPan = true;
        });
        ...
        try {
          ...
          if (mounted) {
            setState(() {
              ...
              if (type == 'pan') _isUploadingPan = false;
            });
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildAadhaarField(),
          const SizedBox(height: 24),
          _buildDocumentCapture('front', 'Aadhaar Front', _aadhaarFront, _isUploadingFront),
          const SizedBox(height: 24),
          _buildDocumentCapture('back', 'Aadhaar Back', _aadhaarBack, _isUploadingBack),
          const SizedBox(height: 24),
          _buildDocumentCapture('selfie', 'Selfie Photo', _selfie, _isUploadingSelfie),
          const SizedBox(height: 24),
          _buildDivider(),
          const SizedBox(height: 24),
          _buildPanField(),
          const SizedBox(height: 24),
          _buildDocumentCapture('pan', 'PAN Card', _panImage, _isUploadingPan),
          const SizedBox(height: 32),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'Your documents are encrypted and stored securely. We never share your personal information. Duplicate Aadhaar numbers are automatically detected and rejected.',
              style: GoogleFonts.plusJakartaSans(
                fontSize: 12,
  ...
  Widget _buildPanField() {
    final error = _validatePan(_panController.text);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        Container(
          ...
          child: TextField(
            ...
            maxLength: 10,
            onChanged: (value) {
              widget.onDataChanged('panNumber', value);
              setState(() {});
            },
            decoration: InputDecoration(
